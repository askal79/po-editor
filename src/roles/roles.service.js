...
var RolesService = /** @class */ (function () {
    function RolesService(userRepository) {
    ...
    RolesService.prototype.createRole = function (dto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userRepository.save(dto)];
                    case 1:
                        role = _a.sent();
    ...
    RolesService = __decorate([
        ...
        __param(0, (0, typeorm_1.InjectRepository)(roles_entity_1.RolesEntity))
    ], RolesService);
    return RolesService;
}());
